...
# from prop_firm_trading_bot.utils.config_loader import AppConfig # Passed in constructor
# from prop_firm_trading_bot.utils.custom_logger import setup_logging # Logger passed in constructor
...
class MT5Adapter(PlatformInterface):
    ...
    def _convert_mt5_symbol_info_to_common_symbol_info(self, mt5_sym_info: Any) -> Optional[SymbolInfo]:
        ...
        return SymbolInfo(
            ...
            min_volume_lots=mt5_sym_info.volume_min,
            max_volume_lots=mt5_sym_info.volume_max,
            volume_step_lots=mt5_sym_info.volume_step,
